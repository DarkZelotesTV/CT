  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[color:var(--color-background)] text-[color:var(--color-text)] p-6">
      <div className="w-full max-w-xl bg-[color:var(--color-surface)]/40 border border-[color:var(--color-border)] rounded-3xl p-6">
        <h1 className="text-[length:var(--font-size-xl)] leading-[var(--line-height-lg)] font-bold mb-2">Clover Identity</h1>
        <p className="text-[length:var(--font-size-sm)] leading-[var(--line-height-base)] text-[color:var(--color-text-muted)] mb-6">
          Keine E-Mail, kein Passwort. Deine Identität ist ein lokaler Schlüssel (wie TS3).
        </p>

        <label className="block text-[length:var(--font-size-sm)] leading-[var(--line-height-base)] text-[color:var(--color-text-muted)] mb-2">Anzeigename (optional)</label>
        <input
          className="w-full rounded-xl bg-[color:var(--color-surface)]/70 border border-[color:var(--color-border)] p-3 mb-4 outline-none text-[length:var(--font-size-base)] leading-[var(--line-height-base)] text-[color:var(--color-text)] focus-visible:border-[var(--color-focus)] focus-visible:ring-2 focus-visible:ring-[var(--color-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)]"
          value={displayName}
        ...
        <div className="flex items-start justify-between gap-4 mb-6">
          <div className="flex-1 text-[length:var(--font-size-sm)] leading-[var(--line-height-base)]">
            <div className="text-[color:var(--color-text-muted)]">Aktuelle Identity</div>
            {identity ? (
              <div className="mt-1 font-mono break-all text-[length:var(--font-size-sm)] leading-[var(--line-height-base)] text-[color:var(--color-text)]">{formatFingerprint(fp!)}</div>
            ) : (
              <div className="mt-1 text-[length:var(--font-size-sm)] leading-[var(--line-height-base)] text-yellow-300">Keine Identity vorhanden.</div>
            )}
            <p className="text-[color:var(--color-text-muted)] mt-2 text-[length:var(--font-size-sm)] leading-[var(--line-height-base)]">
              Erstelle oder importiere zuerst eine Identity. Danach kannst du dich mit einem Server verbinden.
            </p>
          </div>

          <button
            className="px-4 py-2 rounded-xl bg-[color:var(--color-surface-hover)]/80 hover:bg-[color:var(--color-surface-hover)]/90 transition text-[length:var(--font-size-sm)] leading-[var(--line-height-base)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)]"
        ...
        {identity && (
          <>
            <label className="block text-[length:var(--font-size-sm)] leading-[var(--line-height-base)] text-[color:var(--color-text-muted)] mb-2">Server Adresse</label>
            <input
              className="w-full rounded-xl bg-[color:var(--color-surface)]/70 border border-[color:var(--color-border)] p-3 mb-4 outline-none text-[length:var(--font-size-base)] leading-[var(--line-height-base)] text-[color:var(--color-text)] focus-visible:border-[var(--color-focus)] focus-visible:ring-2 focus-visible:ring-[var(--color-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)]"
              value={serverHost}
            ...
            />
            <div className="flex items-center gap-2 mb-4 text-[length:var(--font-size-xs)] leading-[var(--line-height-sm)] text-[color:var(--color-text-muted)]">
              <input
            ...
            <label className="block text-[length:var(--font-size-sm)] leading-[var(--line-height-base)] text-[color:var(--color-text-muted)] mb-2">Server Passwort (optional)
            </label>
            <input
              className="w-full rounded-xl bg-[color:var(--color-surface)]/70 border border-[color:var(--color-border)] p-3 mb-4 outline-none text-[length:var(--font-size-base)] leading-[var(--line-height-base)] text-[color:var(--color-text)] focus-visible:border-[var(--color-focus)] focus-visible:ring-2 focus-visible:ring-[var(--color-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)]"
        ...
        <div className="text-[length:var(--font-size-xs)] leading-[var(--line-height-sm)] text-[color:var(--color-text-muted)] mb-4">
          Du kannst die Server-Verbindung überspringen und später in den Einstellungen setzen.
        </div>

        <div className="flex flex-wrap gap-3">
          <button
            className="px-4 py-3 rounded-xl bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] text-white transition text-[length:var(--font-size-sm)] leading-[var(--line-height-base)] disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)]"
            onClick={handleLogin}
          ...
          <button
            className="px-4 py-3 rounded-xl bg-[color:var(--color-surface-hover)] hover:bg-[color:var(--color-surface)] transition text-[length:var(--font-size-sm)] leading-[var(--line-height-base)] disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)]"
            onClick={handleSkip}
            disabled={!identity}
          >
            Später verbinden
        ...
        {err && <div className="mt-4 text-red-400 text-[length:var(--font-size-sm)] leading-[var(--line-height-base)]">{err}</div>}
