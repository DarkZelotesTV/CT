...
import { ChevronDown, ChevronLeft, ChevronRight, Settings, Users } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col min-w-0 relative h-full py-3 px-3 overflow-auto">
        ...
        <div className="absolute top-4 right-4 z-40 flex gap-2">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-full bg-black/40 border border-white/10 text-gray-300 hover:text-white hover:bg-white/10 backdrop-blur-md shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            aria-label="Servereinstellungen öffnen"
            title={selectedServerId ? 'Servereinstellungen öffnen' : 'Bitte zuerst einen Server auswählen'}
          >
            <Settings size={16} />
