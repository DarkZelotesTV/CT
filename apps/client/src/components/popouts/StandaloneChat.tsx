...
export const StandaloneChat = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-dark-100 text-white font-sans select-none">
      {/* Header */}
      <div className="bg-dark-200 p-3 flex items-center justify-between border-b border-dark-400 shadow-sm drag-region">
        ...
        <button 
          onClick={handleDock}
          className="text-gray-400 hover:text-white p-1 hover:bg-dark-300 rounded transition-colors"
      ...
      <div className="p-4 bg-dark-200 border-t border-dark-400">
        <div className="flex items-center bg-dark-300 rounded-lg px-3 py-2">
            <input className="bg-transparent border-none outline-none text-white text-sm flex-1" placeholder="..." />
            <button className="text-gray-400 hover:text-primary p-1"><Send size={18} /></button>
        </div>
      </div>
    </div>
  );
